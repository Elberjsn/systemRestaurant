    ...
    public ResponseEntity<String> weekChart(HttpServletRequest request) {
        ...
        for (Reserve reserve : reserves) {
            if (reserve.getDtReserve().equals(week)) {
                ...
                charData.replace(week.plusDays(1).getDayOfWeek().toString(), charData.get(week.plusDays(1).getDayOfWeek().toString()) + 1);
            } else if (reserve.getDtReserve().equals(week.plusDays(2))) {
                charData.replace(week.plusDays(2).getDayOfWeek().toString(), charData.get(week.plusDays(2).getDayOfWeek().toString()) + 1);
            } else if (reserve.getDtReserve().equals(week.plusDays(3))) {
                charData.replace(week.plusDays(3).getDayOfWeek().toString(), charData.get(week.plusDays(3).getDayOfWeek().toString()) + 1);
            } else if (reserve.getDtReserve().equals(week.plusDays(4))) {
                charData.replace(week.plusDays(4).getDayOfWeek().toString(), charData.get(week.plusDays(4).getDayOfWeek().toString()) + 1);
            } else if (reserve.getDtReserve().equals(week.plusDays(5))) {
                charData.replace(week.plusDays(5).getDayOfWeek().toString(), charData.get(week.plusDays(5).getDayOfWeek().toString()) + 1);
            } else if (reserve.getDtReserve().equals(week.plusDays(6))) {
                charData.replace(week.plusDays(6).getDayOfWeek().toString(), charData.get(week.plusDays(6).getDayOfWeek().toString()) + 1);
            }
